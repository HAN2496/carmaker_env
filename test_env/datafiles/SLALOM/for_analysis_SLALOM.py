...
def calc_performance(dataset, data_dict):
    ...
    initial_carv = get_value_or_interpolate(data_dict['carx'], data_dict['carv'], 100) * ms2kph
    escape_carv = get_value_or_interpolate(data_dict['carx'], data_dict['carv'], 370) * ms2kph
