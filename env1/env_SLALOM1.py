...
class CarMakerEnv(gym.Env):
    def __init__(self, host='127.0.0.1', port=10001, check=2, matlab_path='C:/CM_Projects/PTC0910/src_cm4sl', simul_path='test_IPG'):
        ...
        self.traj_data_before = pd.read_csv(f"datafiles/{self.road_type}/datasets_traj_SLALOM_env17.csv")
