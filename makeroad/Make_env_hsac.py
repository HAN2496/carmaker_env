...
#        print(f'reset : {self.reset_num}')
    ...
    def step(self, action):
        ...
        state = np.concatenate((np.array([self.car.carx, self.car.cary, self.car.caryaw, self.car.carv]), cones_rel.flatten()))
...
class MetaController:
    def __init__(self, env=DQN, meta_goals=np.array([0, 0, 0, 0, 0]), num_episodes=25000, gamma=0.9, alpha=0.6, batch_size=1, epsilon_anneal=1/2000, meta_epsilon_anneal=1/12000):
        self.env = env
