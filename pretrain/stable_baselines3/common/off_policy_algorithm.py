...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def __init__(
        ...
        #My Code
        self.check_pretrain_buffer_pos = 0
    ...
    def my_rollouts(
        ...
        while should_collect_more_steps(train_freq, num_collected_steps, num_collected_episodes):
            buffer_actions = pretrain_buffer.actions[self.check_pretrain_buffer_pos]
            new_obs = pretrain_buffer.observations[self.check_pretrain_buffer_pos]
            rewards = pretrain_buffer.rewards[self.check_pretrain_buffer_pos]
            dones = pretrain_buffer.dones[self.check_pretrain_buffer_pos]
            infos = info_data[self.check_pretrain_buffer_pos]
            infos = [infos]
            self.check_pretrain_buffer_pos += 1
